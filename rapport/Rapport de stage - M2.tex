...
My work was meant to generalize the work of my supervisor past PhD. student, Martin Baillon. He worked on a roughly similar MLTT extended with

$$ M, N ::= \dots | \alpha$$

with secondary contexts, with $n$ and $b$ an integer and boolean respectively
$$ \mathcal{L}, \ovl n \mapsto \ovl b | \cdot$$
