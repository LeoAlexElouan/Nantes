...
\begin{definition}
    A \emph{geometric formula} is a formula of the form $\forall \overrightarrow{x}, \bigwedge_{i \in I} O_i(\overrightarrow{x}) -> \bigvee_{j\in J}\exists \overrightarrow{y}\bigwedge_{k\in K_j} Q_{j,k}(\overrightarrow{x},\overrightarrow{y})$
\end{definition}

Where $O_i$ and $Q_{j,k}$ are atomic formulas.
...
The prototype of theory that I defined and hoped to study is as follows :
