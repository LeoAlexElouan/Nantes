...
Proof.
  ...
  - revert t'' ht'.
    ...
    1-5: refine (antireduction _ r star_nil). 1-5: clear t r.
    ...
    + induction ht'; try inversion_Redstar.
      * assert (digamma i k' = digamma i0 k) by apply (Redstar_Normal_eq r' Normal_digamma r0 Normal_digamma).
        inversion H; subst.
        apply (inj_right_pair (H:=eqdec)) in H2.
        destruct H2.
        apply (conv_nat_digamma_right hin r r'0).
        apply IHht.
        apply (sem_conv_map (ctx_tl'_OO hin hin)).
        apply hk.
      * assert (digamma i k' = digamma i0 k) by apply (Redstar_Normal_eq r' Normal_digamma r0 Normal_digamma).
